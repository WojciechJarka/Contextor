...
"""
repo_guardian/core/reference/engine.py
...
def build_symbol_references(modules, target_symbols, root_path, definer_module=None, tree_cache=None):
    ...
    for module_id, module in modules.items():
        tree = getattr(module, "ast_tree", None) or _load_tree(root_path, module, tree_cache)
        if tree is None:
            continue
