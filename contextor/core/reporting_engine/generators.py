...
from .formatting import _collision_severity, _compute_status
...
from .risk_signals import _compute_inspection_targets, _compute_module_risk, _compute_risk_summary, _compute_soft_dependencies
