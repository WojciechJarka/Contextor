"""
contextor/core/facts/symbol_index.py
...
def _symbol_id(
    ...
    if parent:
        return f"{module_id}.{parent}.{name}"
...
class SymbolIndexVisitor(ast.NodeVisitor):
    def __init__(
        self,
        module_id: str,
        file_path: str,
