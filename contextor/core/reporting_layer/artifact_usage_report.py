...
def generate_artifact_usage_report(
    ...
    artifact_index = build_artifact_index(module_artifacts)

    shared_artifacts = filter_shared_artifacts(artifact_index)

    clusters = build_shared_usage_clusters(shared_artifacts)
