...
def _header_records(sid: str, started_at: str, desktop_pid: int, file_name: str) -> list[dict[str, object]]:
    records = [
        ...
        {"_type": "domains", "domains": ["DESKTOP", "LIVE", "MCP", "GUI", "ANALYSIS"], "reserved": ["OPS"], "ops_note": "Reserved for future repository-operation coordination; not implemented here."},
