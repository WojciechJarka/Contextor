...
def get_thresholds(nodes: int) -> dict:
    ...
    thresholds = {
        ...
        # ===============================
        "hub_percentile": 0.90,
        "hotspot_percentile": 0.85,
        "outbound_percentile": 0.90,
        "low_complexity_percentile": 0.35,
        # ===============================
        # LEGACY SCORE COMPATIBILITY
        # ===============================
        # used by older modules
        "inspection_score": 0.50,
        "hotspot_score": 0.70,
        "critical_score": 0.85,
    }
